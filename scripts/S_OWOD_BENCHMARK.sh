...
python -u main_open_world.py \
    ...
    --train_set 'task1_train' --test_set 'test' --epochs 41 --lr_drop 31\
    ...
    --exemplar_replay_dir ${WANDB_NAME} --exemplar_replay_cur_file "learned_task1_ft.txt"\
    ${PY_ARGS}
...
python -u main_open_world.py \
    ...
    --train_set 'task2_train' --test_set 'test' --epochs 51\
...
python -u main_open_world.py \
    ...
    --train_set "${WANDB_NAME}/learned_task2_ft" --test_set 'test' --epochs 121 --lr_drop 50\
    --model_type 'prob' --obj_loss_coef 1e-3 --obj_temp 1.3\
...
python -u main_open_world.py \
    ...
    --train_set 'task3_train' --test_set 'test' --epochs 131\
    --model_type 'prob' --obj_loss_coef 1e-3 --freeze_prob_model --obj_temp 1.3\
...
python -u main_open_world.py \
    ...
    --train_set "${WANDB_NAME}/learned_task3_ft" --test_set 'test' --epochs 201 --lr_drop 50\
    --model_type 'prob' --obj_loss_coef 1e-3 --obj_temp 1.3\
...
python -u main_open_world.py \
    ...
    --train_set 'task4_train' --test_set 'test' --epochs 211 \
    --model_type 'prob' --obj_loss_coef 1e-3 --freeze_prob_model --obj_temp 1.3\
...
python -u main_open_world.py \
    ...
    --train_set "${WANDB_NAME}/learned_task4_ft" --test_set 'test' --epochs 301 --lr_drop 50\
    --model_type 'prob' --obj_loss_coef 1e-3 --obj_temp 1.3\

...
exp --output_dir ${EXP_DIR} --PREV_INTRODUCED_CLS 0 --CUR_INTRODUCED_CLS 6 \
    --train_set 'task1_train' --epochs 12 > ${EXP_DIR}/train.log 2>&1

EXP_DIR=exps/OWDETR_t2
exp --output_dir ${EXP_DIR} --PREV_INTRODUCED_CLS 6 --CUR_INTRODUCED_CLS 12 \
    --train_set 'task2_train' --epochs 16 --lr 2e-5 \
    --pretrain 'exps/OWDETR_t1/checkpoint0011.pth' > ${EXP_DIR}/train.log 2>&1

EXP_DIR=exps/OWDETR_t2_ft
exp --output_dir ${EXP_DIR} --PREV_INTRODUCED_CLS 6 --CUR_INTRODUCED_CLS 12 \
    --train_set 'task2_ft' --epochs 28 \
    --pretrain 'exps/OWDETR_t2/checkpoint0015.pth' > ${EXP_DIR}/train.log 2>&1

EXP_DIR=exps/OWDETR_t3
exp --output_dir ${EXP_DIR} --PREV_INTRODUCED_CLS 12 --CUR_INTRODUCED_CLS 18 \
    --train_set 'task3_train' --epochs 32 --lr 2e-5 \
    --pretrain 'exps/OWDETR_t2_ft/checkpoint0027.pth' > ${EXP_DIR}/train.log 2>&1

EXP_DIR=exps/OWDETR_t3_ft
exp --output_dir ${EXP_DIR} --PREV_INTRODUCED_CLS 12 --CUR_INTRODUCED_CLS 18 \
    --train_set 'task3_ft' --epochs 44 \
    --pretrain 'exps/OWDETR_t3/checkpoint0026.pth' > ${EXP_DIR}/train.log 2>&1

EXP_DIR=exps/OWDETR_t4
exp --output_dir ${EXP_DIR} --PREV_INTRODUCED_CLS 18 --CUR_INTRODUCED_CLS 24 \
    --train_set 'task4_train' --epochs 48 --lr 2e-5 \
    --pretrain 'exps/OWDETR_t3_ft/checkpoint0043.pth' > ${EXP_DIR}/train.log 2>&1

EXP_DIR=exps/OWDETR_t4_ft
exp --output_dir ${EXP_DIR} --PREV_INTRODUCED_CLS 18 --CUR_INTRODUCED_CLS 24 \
    --train_set 'task4_ft' --epochs 60 \
    --pretrain 'exps/OWDETR_t4/checkpoint0047.pth' > ${EXP_DIR}/train.log 2>&1